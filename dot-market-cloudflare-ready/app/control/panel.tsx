...
type Application = {
  id: string; mcNick: string; affiliation: string; job: string;
...
export default function ControlPanel({ initialShops, initialReviews, initialApplications }: {
  initialShops: Shop[];
  ...
  const fillFromApplication = (application: Application) => {
    ...
    say(`"${application.shopName}" 내용을 새 샵 만들기에 채웠습니다. 관리자 이메일만 넣고 만드세요.`);
