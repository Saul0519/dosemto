...
export default function ControlPanel({
  ...
  storeItems, storePurchases, storeReviews, storeChannelId, storeGuildId, popup, stats,
}: {
  initialShops: Shop[];
